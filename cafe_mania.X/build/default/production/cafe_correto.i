...
# 10 "/opt/microchip/xc8/v2.10/pic/include/c99/ctype.h" 3
int isalnum(int);
int isalpha(int);
int isblank(int);
int iscntrl(int);
...
int tolower(int);
int toupper(int);
# 41 "/opt/microchip/xc8/v2.10/pic/include/c99/ctype.h" 3
# 1 "/opt/microchip/xc8/v2.10/pic/include/c99/bits/alltypes.h" 1 3
# 42 "/opt/microchip/xc8/v2.10/pic/include/c99/ctype.h" 2 3
...
void trata (char RECEP);
void cafe(void);
void cafe_expresso(void);
void capuccino(void);
void botao(void);
void envia(int n);
